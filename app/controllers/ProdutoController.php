    ...
    public function listar($id = null)
    {
        if ($id) {
            try {
                ...
                View::renderWithLayout('produto/DetalheProdutoView', 'config/AppLayout', ['produto' => $produto]);
            ...
            View::renderWithLayout('produto/ListagemProdutoView', 'config/AppLayout', ['listaProdutos' => $produtos]);
        }
    }
