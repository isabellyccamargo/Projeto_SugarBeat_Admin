...
$caminhoImagemAtual = $produto && $produto->getImagem()
    ? '/sugarbeat_admin/' . htmlspecialchars($produto->getImagem())
    : 'caminho/para/sua/imagem_do_brigadeiro.png'; // Placeholder
?>
                    ...
                    <div class="form-row ">
                        <div class="campo-grupo id-campo esquerda">
                            ...
                            <input type="text" id="id" name="id" readonly
                                value="<?= $is_editing ? htmlspecialchars($produto->getIdProduto()) : '' ?>">
                    ...
                    <div class="form-row">
                        <div class="campo-grupo esquerda">
                            ...
                            <select id="categoria" name="categoria" class="campo-select input-display" required>
                                <option value="" disabled <?= !$is_editing ? 'selected' : '' ?>>Selecione</option>
                                <?php
                                // Define a categoria a ser selecionada, priorizando o produto com erro
                                ...
                                if (isset($listaCategorias) && is_array($listaCategorias)):
                                    foreach ($listaCategorias as $categoria):
                                        ...
                                        // Verifica se o ID da categoria atual no loop é o ID da categoria que deve ser selecionada
